...
var Swiper = function() {
        ...
        I = e => {
            ...
            if (e.params.rewind || e.params.loop)
                for (let i = r - t; i <= n + t; i += 1) {
                    ...
                    for (let i = Math.max(r - t, 0); i <= Math.min(n + t, s - 1); i += 1) i !== r && (i > n || i < r) && P(e, i)
        };
    var L = {
        updateSize: function() {
            const e = this;
    ...
    var z = {
        ...
        loopFix: function(e) {
            ...
            if (l.__preventObserver__ = !0, requestAnimationFrame((() => {
                ...
                })), l.recalcSlides(), "auto" === h.slidesPerView ? l.updateSlides() : S && (T.length > 0 && E || b.length > 0 && y) && l.slides.forEach(((e, t) => {
                ...
                if (T.length > 0 && E) {
                    if (void 0 === t) {
                        ...
                        o ? l.setTranslate(l.translate - t) : (l.slideTo(x + Math.ceil(M), 0, !1, !0), r && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - t, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - t))
                    } else if (r) {
    ...
    function _(e) {
        ...
        if (n.touchReleaseOnEdges && (x = 0), v > 0 ? (S && T && r.allowThresholdMove && r.currentTranslate > (n.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
                ...
                setTranslate: !0,
                activeSlideIndex: 0
            }), r.currentTranslate > s.minTranslate() && (b = !1, n.resistance && (r.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + r.startTranslate + v) ** x))) : v < 0 && (S && T && r.allowThresholdMove && r.currentTranslate < (n.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
                direction: "next",
                setTranslate: !0,
    ...
    class U {
        ...
        getSlideIndex(e) {
            const {
                slidesEl: t,
                params: s
            } = this, i = g(h(t, `.${s.slideClass}, swiper-slide`)[0]);
            return g(e) - i
        }
        ...
        mount(e) {
            ...
            return !r && t.params.createElements && (r = m("div", t.params.wrapperClass), s.append(r), h(s, `.${t.params.slideClass}`).forEach((e => {
                r.append(e)
            }))), Object.assign(t, {
                el: s,
                wrapperEl: r,
